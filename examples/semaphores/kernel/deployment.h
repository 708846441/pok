...
//#define POK_NEEDS_SCHED_RMS_PARTITIONS  1
#define POK_NEEDS_SCHED_EDF_PARTITIONS  1
...
#define POK_CONFIG_PARTITIONS_PERIOD {42, 41}
#define POK_CONFIG_PARTITIONS_DEADLINE {42, 41}
